...
curl -i -X PUT -H "Content-Type: text/turtle" --data-binary @ldp-membership.ttl  -H 'Link: <http://www.w3.org/ns/ldp#IndirectContainer>;rel="type"' $FCREPO/objects/raven/members/
...
curl -i -X PUT   -H "Content-Type: text/turtle"               --data-binary @ldp-cover-direct.ttl -H 'Link: <http://www.w3.org/ns/ldp#DirectContainer>;rel="type"' $FCREPO/objects/cover/files/
...
curl -i -X PUT -H   "Content-Type: text/turtle"               --data-binary @ldp-page0-direct.ttl -H 'Link: <http://www.w3.org/ns/ldp#DirectContainer>;rel="type"' $FCREPO/objects/page0/files/
...
curl -i -X PUT -H   "Content-Type: text/turtle"               --data-binary @ldp-page1-direct.ttl -H 'Link: <http://www.w3.org/ns/ldp#DirectContainer>;rel="type"' $FCREPO/objects/page1/files/
...
curl -i -X PUT -H "Content-Type: text/turtle" --data-binary @ldp-indirect.ttl     -H 'Link: <http://www.w3.org/ns/ldp#IndirectContainer>;rel="type"' $FCREPO/collections/poe/members/
...
curl -i -X PUT   -H "Content-Type: text/turtle"               --data-binary @ldp-ordering-alternate.ttl -H 'Link: <http://www.w3.org/ns/ldp#IndirectContainer>;rel="type"' $FCREPO/objects/alternateOrder/members/
